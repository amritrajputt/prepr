...
export function InputField({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await uploadGithubUsername(username, token)
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-6">
      <form
        ...
        className="rounded-2xl border border-border bg-card shadow-sm p-5 transition-all focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-emerald-500"
      >
