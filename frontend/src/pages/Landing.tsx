            ...
            <div className="flex items-center gap-8">
              ...
              <Show when="signed-out">
                <SignInButton mode="modal">
                  <button className="group relative inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-foreground hover:text-emerald-500 bg-secondary hover:bg-secondary/80 border border-border rounded-xl transition-all duration-200 active:scale-95 cursor-pointer">
                    <svg className="w-4 h-4 mr-1.5 text-muted-foreground group-hover:text-emerald-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
